        ...
        <section id="werke" class="white-theme">
            <div class="d-flex flex-column">
                ...
                <?php if (have_rows('portfolio_tab')) : while (have_rows('portfolio_tab')) : the_row(); ?>
                        <a class="read-more-toggle link align-self-center mt-5"><?php the_sub_field('portfolio_tab_title'); ?>
                        ...
                        <div class="read-more-content mt-3">
                            <div class="d-flex flex-column align-items-center">
                                ...
                                <a href="#werke" class="mt-3 link closeWerke smooth_scroll">
                            ...
                            <?php if (have_rows('about_us_social_media')) : while (have_rows('about_us_social_media')) : the_row(); ?>
                                    ...
                                    <div class="d-flex mt-3 justify-content-center">
                                        <?php if (have_rows('about_us_social_media_items')) : while (have_rows('about_us_social_media_items')) : the_row(); ?>
                                                <a class="link ml-1 mr-1" href="<?php the_sub_field('about_us_social_media_items_link'); ?>" target="_blank">
                                                    <i class="fab <?php the_sub_field('about_us_social_media_items_class_icon'); ?>"></i>
                                                </a>
                                        <?php endwhile;
                                        endif; ?>
                                    </div>
                ...
                <div class="mt-3 pt-3 row">
                    <?php if (have_rows('internet_article_items')) : while (have_rows('internet_article_items')) : the_row(); ?>
                            <div class="col-md-12 col-lg-6 col-xl-4 mb-4">
                                <h4>
                                    <i class="fas mr-2 <?php the_sub_field('internet_article_items_name_icon'); ?>" aria-hidden="true"></i><?php the_sub_field('internet_article_items_title'); ?></h4>
                                <ul class="ul-style-1">
