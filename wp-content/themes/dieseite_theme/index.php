...
<?php if (have_rows('first_screen')) : while (have_rows('first_screen')) : the_row(); ?>
        <div id="home" class="parallax-window" data-parallax="scroll" data-image-src="<?php the_sub_field('first_screen_background_image'); ?>">
            ...
            <div class="h-100">
                <div class="d-flex h-100 flex-column justify-content-center align-items-center position-relative">
                    ...
                    <span class="description auto-typing"></span>
                                ...
                                window.addEventListener('load', () => {
                                    $(function() {
                                        new TypeIt('.auto-typing', {
                                            ...
                                            //            })
                                            //            .pause(300)
                                            //            .type('für kleine und mittlere Unternehmen')
                                            //            .break()
                                            //            .pause(500)
                                            //            .options({
                                            //                speed: 70
...
<?php if (have_rows('section_was')) : while (have_rows('section_was')) : the_row(); ?>
        <section id="was" class="white-theme">
            ...
            <div class="d-flex px-1 px-md-3 px-lg-5 flex-column align-items-center align-items-lg-stretch">
                <?php if (have_rows('section_was_info_box')) : while (have_rows('section_was_info_box')) : the_row(); ?>
                        <div data-brackets-id="47" class="<?php the_sub_field('section_was_info_box_classes'); ?>">
                ...
                <?php if (have_rows('section_was_contact_link')) : while (have_rows('section_was_contact_link')) : the_row(); ?>
                        <div class="anm_mod right position-relative w-100 d-flex flex-column flex-lg-row justify-content-center mt-5 p-3 active">
                            <h3 class="text-center text-lg-left"><?php the_sub_field('section_was_contact_link_text'); ?></h3>
                    ...
                    <div class="col-12 col-lg-6 mb-3">
                        <div class="">
                            <div id="carouselExampleInterval" class="carousel slide" data-ride="carousel">
                                ...
                                <a class="carousel-control-prev car" href="#carouselExampleInterval" role="button" data-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                    <span class="sr-only">Previous</span>
                                </a>
                                <a class="carousel-control-next car" href="#carouselExampleInterval" role="button" data-slide="next">
                            ...
                            <?php if (have_rows('about_us_social_media')) : while (have_rows('about_us_social_media')) : the_row(); ?>
                                    ...
                                    <div class="d-flex mt-3 justify-content-center">
                                        <?php if (have_rows('about_us_social_media_items')) : while (have_rows('about_us_social_media_items')) : the_row(); ?>
                                                <a class="link ml-1 mr-1" href="<?php the_sub_field('about_us_social_media_items_link'); ?>" target="_blank"><i class="fab <?php the_sub_field('about_us_social_media_items_class_icon'); ?>"></i></a>
                                        <?php endwhile;
                                        endif; ?>
                                    </div>
                            <?php endwhile;
                ...
                <div class="mt-3 pt-3 row">
                    <?php if (have_rows('internet_article_items')) : while (have_rows('internet_article_items')) : the_row(); ?>
                            <div class="col-md-12 col-lg-6 col-xl-4 mb-4">
                                <h4><i class="fas mr-2 <?php the_sub_field('internet_article_items_name_icon'); ?>" aria-hidden="true"></i><?php the_sub_field('internet_article_items_title'); ?></h4>
                                <ul class="ul-style-1">
